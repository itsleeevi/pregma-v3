  ...
  return (
    <>
          ...
          <svg width="956" height="792" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              <linearGradient id="grad3">
                <stop offset="20%" stopColor="#1e00ff" />
                <stop offset="80%" stopColor="#0d0261" />
              </linearGradient>
            </defs>
      ...
      >
        ...
        >
          <svg width="856" height="792" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <filter id="shadow">
                <feGaussianBlur in="SourceAlpha" stdDeviation="5" />
                <feOffset dx="0" dy="0" result="offsetblur" />
      ...
      >
        ...
        >
          <svg width="856" height="992" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <filter id="shadow">
                <feGaussianBlur in="SourceAlpha" stdDeviation="5" />
                <feOffset dx="0" dy="0" result="offsetblur" />
